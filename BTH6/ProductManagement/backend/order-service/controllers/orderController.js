...
const createOrder = async (req, res) => {
    try {
        ...
        for (const item of products) {
            ...
            // Sử dụng unit_price từ request nếu có, nếu không lấy từ product
            const unitPrice = item.unit_price || item.unitPrice || check.product.price;
...
// Cập nhật đơn hàng (PUT) - theo yêu cầu BTH6
